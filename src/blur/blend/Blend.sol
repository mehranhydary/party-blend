...
contract Blend is IBlend, OfferController, UUPSUpgradeable {
    ...
    function _repay(
        ...
        debt = CalculationHelpers.computeCurrentDebt(
            lien.amount,
            lien.rate,
            lien.startTime
        );
    ...
    function refinance(
        ...
        uint256 debt = CalculationHelpers.computeCurrentDebt(
            lien.amount,
            lien.rate,
            lien.startTime
        );
    ...
    IExchange private constant _EXCHANGE =
        IExchange(0x000000000000Ad05Ccc4F10045630fb830B95127);
    address private constant _SELL_MATCHING_POLICY =
        0x0000000000daB4A563819e8fd93dbA3b25BC3495;
    address private constant _BID_MATCHING_POLICY =
        0x0000000000b92D5d043FaF7CECf7E2EE6aaeD232;
    address private constant _DELEGATE =
    ...
    function takeBid(
        ...
        uint256 amountReceivedFromSale = pool.balanceOf(address(this)) -
            balanceBefore;
    ...
    function _takeSellOffer(
        ...
        /* Transfer fees. */
        uint256 totalFees = _transferFees(
            sellOffer.fees,
            msg.sender,
            sellOffer.price
        );
